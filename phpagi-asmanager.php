  ...
  */
  class AGI_AsteriskManager
  {
    ...
    */
    ...
    {
      // load config
      $config = Yii::$app->params['phpariConfig'];
      ...
      if(!isset($this->config['asmanager']['username'])) $this->config['asmanager']['username'] = 'ami';
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = 'amipass';
    }
